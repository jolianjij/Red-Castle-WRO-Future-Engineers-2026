...
STEER_MAX = 30          # deg - SOFTWARE steering limit actually used when driving.
...
LINE_FRACTION_ORANGE = 0.035   # orange is faint -> accept it sooner
LINE_FRACTION_BLUE   = 0.07   # blue over-triggers -> demand more of it
